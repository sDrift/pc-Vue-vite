    ...
    <div class="test-section">
      ...
      <div class="draggable-container">
        ...
        <div 
          ...
          @click="handleElementClick('main', $event)"
        >
        ...
        <div class="multiple-draggables">
          ...
          <div 
            v-draggable 
            class="draggable-small blue"
            @click="handleElementClick('blue', $event)"
          >
            元素1
          </div>
          <div 
          ...
          <div 
            v-draggable 
            class="draggable-small red"
            @click="handleElementClick('red', $event)"
          >
            元素3
          </div>
        </div>
